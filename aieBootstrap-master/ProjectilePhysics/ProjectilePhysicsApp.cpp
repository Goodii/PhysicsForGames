...
bool ProjectilePhysicsApp::startup() {
	...
	m_physicsScene->setGravity(glm::vec2(0.f, -10.f));
	...
	auto plane = new Plane({ 0, 1 }, 0);
	auto rSphere = new Sphere(startPos, glm::vec2(0, 0), 30.f, 3.f, glm::vec4(1, 0, 0.5, 1));

	m_physicsScene->addActor(rSphere);
	m_physicsScene->addActor(new Sphere(glm::vec2(40, 10), glm::vec2(-5, 0), 10.f, 4.f, glm::vec4(1, 0, 0, 1)));
